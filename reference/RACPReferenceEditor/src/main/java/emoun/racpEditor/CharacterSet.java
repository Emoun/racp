...
//Fields
	...
	public static final byte RACP_ESCAPE = 5;
	public static final byte RACP_SLASH = 6;
	public static final byte RACP_BACKSLASH = 7;
	public static final byte RACP_RPILCROW = 8;
	public static final byte RACP_PILCROW = 9;
	public static final byte RACP_LDAQ = 10;
	public static final byte RACP_RDAQ = 11;
	public static final byte RACP_LLATH = 12;
	public static final byte RACP_RLATH = 13;
	public static final byte RACP_LJAMB = 14;
	public static final byte RACP_RJAMB = 15;
	...
	public static final byte RACP_LA_BRACKET = 22;
	public static final byte RACP_RA_BRACKET = 23;
	public static final byte RACP_LT = 24;
	public static final byte RACP_GT = 25;
	public static final byte RACP_EQUAL = 26;
	public static final byte RACP_NOT = 27;
	...
	public static final byte RACP_DIVISION = 94;
	public static final byte RACP_PERCENT = 95;
	public static final byte RACP_SECTION = 96;
